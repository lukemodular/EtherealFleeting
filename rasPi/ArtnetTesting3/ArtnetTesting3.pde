...
// setup artnet 
ArtNetClient artnet;
int numLedUniverse = 24; // 48 eventually + 4 for smoke machine and 4 for the lighting
int numPixelUniverse = 28;
int numLedChannels = 510;
...
void drawImageToScreen() {
  ...
  currentImageIndex = (defaultImageIndex + millis() / (5000*10)) % maxImages;
...
int playBackSpeed(int index) {
  return (frameCount + index)% 160 + 60;
}
