...
void draw()
{
  ...
  artnet.unicastDmx("192.168.2.11", 0, 0, dmxData);
  artnet.unicastDmx("192.168.2.12", 0, 0, dmxData);
  //artnet.unicastDmx("192.168.2.13", 0, 0, dmxData);
  //artnet.unicastDmx("192.168.2.14", 0, 0, dmxData);
  //artnet.unicastDmx("192.168.2.15", 0, 0, dmxData);
  //artnet.unicastDmx("192.168.2.16", 0, 0, dmxData);
