...
//Leave this alone.  At current a full e1.31 frame is 636 bytes..
 ...
 #define NUM_LEDS 300 // with current fastLED and OctoWs2811 libraries buffers... do not go higher than this - Runs out of SRAM
 #define CHANNEL_COUNT 900 //because it divides by 3 nicely
