...
#define NUM_LEDS 2380 // with current fastLED and OctoWs2811 libraries buffers... do not go higher than this - Runs out of SRAM
#define CHANNEL_COUNT 7140 //because it divides by 3 nicely
